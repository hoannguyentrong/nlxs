...
$(document).ready(function() {
    ...
    //             if (!isMapLoaded) {
                    ...
                    map = new GMaps({
                        el: '#gmap-wrapper',
                        lat: 10.7368091, //Replace Here Location Google Map Lat
                        lng: 106.7181896, //Replace Here Location Google Map Lng
                        scrollwheel: false,
                        zoom: 17,
                        zoomControl: true,
                        panControl: true,
                    ...
                    map.addMarker({
                        lat: 10.7368091, //Replace Here Location Google Map Lat
                        lng: 106.7181896, //Replace Here Location Google Map Lat
                        icon: image,
